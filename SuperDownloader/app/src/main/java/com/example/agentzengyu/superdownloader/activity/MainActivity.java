...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private Button mbtnNew, mbtnCurrent, mbtnHistory, mbtnSetting;
    ...
    private void initView() {
        (mbtnNew = (Button) findViewById(R.id.btnNew)).setOnClickListener(this);
        (mbtnCurrent = (Button) findViewById(R.id.btnCurrent)).setOnClickListener(this);
        (mbtnHistory = (Button) findViewById(R.id.btnHistory)).setOnClickListener(this);
        (mbtnSetting = (Button) findViewById(R.id.btnSetting)).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        mbtnNew.setTextColor(Color.BLACK);
        mbtnCurrent.setTextColor(Color.BLACK);
        mbtnHistory.setTextColor(Color.BLACK);
        ...
        switch (v.getId()) {
            case R.id.btnNew:
                ...
                transaction.commit();
                mbtnNew.setTextColor(Color.YELLOW);
                break;
            case R.id.btnCurrent:
                transaction.replace(R.id.container, currentFragment);
                transaction.commit();
                mbtnCurrent.setTextColor(Color.YELLOW);
                break;
            case R.id.btnHistory:
                transaction.replace(R.id.container, historyFragment);
                transaction.commit();
                mbtnHistory.setTextColor(Color.YELLOW);
                break;
            case R.id.btnSetting:
                transaction.replace(R.id.container, settingFragment);
                transaction.commit();
                mbtnSetting.setTextColor(Color.YELLOW);
                break;
            default:
                break;
        }
